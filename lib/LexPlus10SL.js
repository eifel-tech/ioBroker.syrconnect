...
const LexPlus10SL = function (id, name) {
	...
	this.getTYP = new Datapoint("Device type", nbr, "", null, null, null, false, null);
	...
	this.getAB = new Datapoint("Valve", nbr, "", 1, 2, 1, true, { 1: "open", 2: "close" });
	...
	this.getIPA = new Datapoint("IP address", str, "", null, null, null, false, null);
	this.getLAR = new Datapoint("Last Regeneration", nbr, "", 0, null, null, false, null);
	this.getCOF = new Datapoint("Past cumulative water usage", nbr, "l", 0, null, null, false, null);
	...
	this.getCEL = new Datapoint("Water temperature", nbr, "°C", 0, 100, 0, false, null);
	...
	this.getSS1 = new Datapoint("Salt supply 1", nbr, "Wochen", 0, 52, 0, false, null);
	...
	this.getUL = new Datapoint("Leakage protection mode", nbr, "", 0, 1, 0, true, { 0: "present", 1: "absent" });
	this.getTC = new Datapoint("", str, "", null, null, null, false, null);
	this.getNPS = new Datapoint("Leakage amount", nbr, "ml", 0, null, 0, false, null);
	this.getTO = new Datapoint("", str, "", null, null, null, false, null);
	this.getVLV = new Datapoint("Valve status", nbr, "", 10, 21, 20, false, {
		10: "closed",
		11: "closing",
		20: "open",
		21: "opening",
